...
In essence, we greedily add the $f_t$ that improves our model the most.

Applying the Taylor's Theorem Approximation, we can render a second-order approximation of the equation above:
...
This function can be thought of as a quality measure of the tree structure $q$ and can also be thought of as the impurity score.
